...
An ActiveRecord/Rails library to add @after_commit@ callback. These callback is focused on the transactions, instead of specific model actions. This is especially important with cache expiry. 
